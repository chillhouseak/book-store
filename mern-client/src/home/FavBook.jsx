...
import favbookimg from "../assests/favoritebook.jpg";
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center'>
      <div className='md:w-1/2'>
        <img src={favbookimg} className='rounded md:w-10/12' alt='Favorite Book' />
      </div>
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='mb-10 text-lg md:w-5/6'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Discover and enjoy your next favorite book.
        </p>
